...
| Shared reference knowledge | 79 nodes, 116 conditional relations, 26 primary sources; explicit runtime Windows error lookup | Implemented separately from machine evidence; game frame-time, other-monitor/dynamic-refresh and per-game GPU-engine observations remain absent |
