...
The current schema-30 event path retains source-event custody independently of
legacy follow-ups. It reserves at most one decision slot in each ordinary
